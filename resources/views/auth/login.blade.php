...
<main class="flex flex-col justify-center p-6 pb-12">
    ...
    <div class="mx-auto mt-6 w-full max-w-md rounded-xl bg-white/80 p-6 shadow-xl backdrop-blur-xl sm:mt-10 sm:p-10">
        @error('credentials')
        <div class="flex gap-3 rounded-md border border-red-500 bg-red-50 p-4 mb-6">
        ...
        <form action="{{ route('auth.login') }}" method="POST" autocomplete="off">
            ...
            <div>
                <button type="submit" class="w-full flex items-center justify-center rounded-md bg-green-600 py-2 px-4 font-semibold text-white shadow-lg transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">@lang('auth.login')</button>
            </div>
        </form>
    </div>
</main>
