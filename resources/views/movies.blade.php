                        ...
                        <div class="overflow-hidden">
                            <div class="p-4 items-center">
                                <form action="{{ route('movies') }}" method="GET">
                                    ...
                                    <a href="{{ route('movies') }}" class="rounded-md bg-grey-600 py-2 px-4 font-semibold text-black shadow-lg transition duration-150 ease-in-out hover:bg-grey-900 hover:shadow-xl focus:shadow-xl focus:outline-none focus:ring-2 focus:ring-grey-500 focus:ring-offset-2">@lang('movies.reset_search')</a>
                                </form>
                            </div>
